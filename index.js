...
async function addMarkers() {
    for (const location of stargazingSpots) {
        ...
        const popupContent = `
            ...
            <br>
            <button onclick="window.open('https://www.lightpollutionmap.info/#zoom=4.38&lat=27.4043&lon=77.4515&state=eyJiYXNlbWFwIjoiTGF5ZXJCaW5nUm9hZCIsIm92ZXJsYXkiOiJ3YV8yMDE1Iiwib3ZlcmxheWNvbG9yIjpmYWxzZSwib3ZlcmxheW9wYWNpdHkiOjYwLCJmZWF0dXJlc29wYWNpdHkiOjg1fQ==')">View Light Pollution Map</button>
        `;
